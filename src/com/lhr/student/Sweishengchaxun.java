...
class Sweishengchaxun extends JFrame implements ActionListener {
	JLabel JL = new JLabel("查询卫生", JLabel.CENTER);// 使用文本创建一个标签对象
	...
	public Sweishengchaxun() // 创建SetGrade构造函数
	{
		this.setTitle("学生—查询卫生");// 设置窗口标题
		...
		JLNumber.setBounds(120, 80, 100, 20);// 设置宿舍号标签的初始位置
		this.add(JLNumber);// 将学号标签添加到容器
		JTNumber.setBounds(220, 80, 80, 20);// 设置文本框的初始位置
		...
		resultarea.setForeground(Color.blue);// 设置标签的前景色
		...
		this.setBounds(10, 10, 470, 380);// 设置窗口尺寸大小
