...
class TLiFanchaxun extends JFrame implements ActionListener {
	JLabel JL = new JLabel("学生离返校信息查询", JLabel.CENTER);// 使用文本创建一个标签对象
	...
	public TLiFanchaxun() // 创建SetGrade构造函数
	{
		...
		JBNext.setBounds(205, 120, 70, 20);// 设置重置按钮的初始位置
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == JBSet) // 处理"查询"事件
		{
			...
			sql = "select * from  LeaveBackSchool where Sno='" + Sno + "'";// 检索出Id等于snumber的学生的所有信息
