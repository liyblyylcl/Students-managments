...
public class TStudent extends JFrame implements ActionListener {
	...
	public TStudent() throws IOException {
		...
		// 设置背景图片
		imgBackground = new ImageIcon("images\\002.jpg");// 背景图片,
		...
		jb2 = new JButton(new ImageIcon("images\\新生入住.gif"));
		jb2.setOpaque(false);
		jb2.setToolTipText("点击可以插入新入住学生！");
		jb2.addActionListener(this);
		jb2.setBounds(200, 420, 120, 33);

		jb3 = new JButton(new ImageIcon("images\\学生查询.gif"));
		jb3.setOpaque(false);
		jb3.setToolTipText("点击可以查询与修改学生的信息！");
		jb3.addActionListener(this);
		jb3.setBounds(380, 420, 120, 33);

		jb4 = new JButton(new ImageIcon("images\\返回.gif"));
		jb4.setOpaque(false);
