...
class Tshuidianfeichaxun extends JFrame implements ActionListener {
	...
	public Tshuidianfeichaxun() // 创建SetGrade构造函数
	{
		this.setTitle("管理员—查询水电费");// 设置窗口标题
		...
		this.setBounds(10, 10, 540, 400);// 设置窗口尺寸大小
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == JBSet) // 处理"查询"事件
		{
			...
			try // 异常处理
			{
				...
				{
					resultarea
							.setText("宿舍号    起始日期       终止日期     水费(元) 电费(元)  总计(元) "
									+ "\n");
	...
	public static void main(String args[]) {
		new Tshuidianfeichaxun();// 实例化一个对象
	}
}
